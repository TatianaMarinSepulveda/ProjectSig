@csrf
<div class="block">
    <x-jet-label for="NombreUsuario" value="{{ __('Nombre Complerp') }}" />
    ...
    <x-jet-input id="PasswordUsuario" class="block mt-1 w-full" type="text" name="PasswordUsuario" :value="old('PasswordUsuario', $usuario->PasswordUsuario)" required autofocus />
